...
// ── UUID polyfill (for older browsers / GitHub Pages) ─────────────────────────
...
const REAL_PLAYERS = [
  ...
  // Legends
  { name: "Wayne Rooney",        age: 38, position: "FWD", overall: 69, potential: 69, value: 1.0,   teamIndex: 6 },
  ...
  { name: "Amad Diallo",         age: 22, position: "FWD", overall: 78, potential: 88, value: 55.0,  teamIndex: 12 },
  // Legends
  ...
  // Legends
  { name: "Kevin Gallagher",     age: 59, position: "FWD", overall: 65, potential: 65, value: 0.5,   teamIndex: 13 },
